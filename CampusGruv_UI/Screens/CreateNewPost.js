  ...
  static navigationOptions = props => {
    ...
    return {
      header:
        ...
        <View style={{height: 80, backgroundColor: '#1192d1', flexDirection: 'row' ,justifyContent: 'center',marginTop:Platform.OS == "ios" ? StatusBar.currentHeight : 0}}>
            <View style={{position: 'absolute',bottom:Platform.OS=='ios'?5:0 , padding:2, alignSelf: 'center', left: 8,marginTop:Platform.OS=='ios'? 40:0}}>
                <TouchableOpacity 
                    onPress = {() => {
            ...
            <View style={{alignSelf: 'center',marginTop:Platform.OS=='ios'? 30:0}}>
                <Text style={{color: 'white', fontSize:20, fontWeight:'bold'}}>New post</Text>
            </View>
            <View style={{position: 'absolute', padding:2,bottom:Platform.OS=='ios'?5:0 , alignSelf: 'center', right: 8,marginTop:Platform.OS=='ios'? 40:0}}>
                <TouchableOpacity 
                    onPress = {() => {
